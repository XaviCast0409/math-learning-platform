...
import { ShopCard } from '../../components/shop/ShopCard'; // Ajusta ruta si es necesario
import { InventoryCard } from '../../components/shop/InventoryCard'; // Ajusta ruta si es necesario
